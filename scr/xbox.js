...
const productos =[
        ...
        productosAMostrar.forEach((elementoDelArray) => {
            ...
            <div class="product"> <img src="${elementoDelArray.imagen}">
                <ul class="d-flex align-items-center justify-content-center list-unstyled icons">
                    ...
                    <li class="icon"><span onclick="agregarAlCarrito(${elementoDelArray.id}),mCarrito()" class="fas fa-shopping-bag"></span></li>
                </ul>
            </div>
    ...
    const mostrarCarrito = document.getElementById('cantidadCarrito');
    ...
    function mCarrito() {
        ...
        for (var i = 0; i < carrito.length; i++) {
            ...
            mostrarCarrito.innerHTML = mostrarCarrito.innerHTML +
            `<div class="col-12 product-item">
            <div class="product">
            <img src="${carrito[i].imagen}">
            </div>
            <div class="title">${carrito[i].nombreJuego}</div>
            <div class="title">$${carrito[i].precio}</div>
